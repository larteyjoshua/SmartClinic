        ...
        <form method = "POST" action="appointment.php" class="login100-form validate-form">
          ...
          <form method="POST" action="appointment.php">
            ...
            <div  class="form-group" data-validate="Phone Number">
              ...
              <div class="form-group">
                  <div class="form-group">
                    ...
                    Deparment  <select name="department" id="department_name" class="form-" label="Department">
                        <option value="1."> General </option>
                        <option value="2"> Physio</option>
                        <option value="3.">Paediatrics</option>
                        <option value="4.">Dental</option>
                        <option value="5.">Gyaenacology</option>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="date" name="date" class="form-control appointment_date" placeholder="Date (dd/mm/yy)">
                </div>    
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <!-- <label for="appointment_time" class="text-black">Time</label> -->
                  <input type="time" name="time" id="appointment_time" class="form-control appointment_time" placeholder="Time (hr:min.am/pm)">
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <textarea type= "text" name="message"  class="form-control" cols="30" rows="6" placeholder=" Brief Message of your condition (Optional)"></textarea>
            </div>
            <div class="form-group">
